...
public final class BancoDadosSingleton {
    private final String NOME_BANCO = new String("pokemon_go_db");
    public static BancoDadosSingleton getInstance() {
        return ourInstance;
    }
    private static BancoDadosSingleton ourInstance = new BancoDadosSingleton();
    private final String[] SCRIPT_DATA_BASE_CREATE = new String[]{"CREATE TABLE pokemon (" +
            ...
            "INSERT INTO pokemon (idPokemon, nome, categoria, foto, icone) VALUES" +
                    ...
                    "(133, 'Eevee', 'I', " + R.drawable.p130 + "," + R.drawable.i133 + ")," +
